package com.example.completeandroidknowledge.sectionPublic.dialog.optionsDialog
...
class OptionsDialogPublic(): BaseDialogPublic(),
    ...
    companion object{
        ...
        fun newOptionsDialog(title: String, message: String, positiveButtonCaption: String, negativeButtonCaption: String): OptionsDialogPublic {
            val infoDialog =
                OptionsDialogPublic();
            val bundle = Bundle(3)
