...
class OptionsDialog(): BaseDialog(), OptionDialogMVCView.Listener {
    ...
    override fun onPositiveButtonClicked() {
        onButtonClick()
        dialogEventBus.postEvent(OptionDialogEvent(OptionDialogEvent.Button.POSITIVE))

    }

    override fun onNegativeButtonClicked() {
        onButtonClick()
        dialogEventBus.postEvent(OptionDialogEvent(OptionDialogEvent.Button.NEGATIVE))
    }
}